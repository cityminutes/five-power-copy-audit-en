# AI Copywriting Audit | Five-Power Commercial Copy Review
...
```bash
git clone https://github.com/cityminutes/ai-copywriting-audit-en.git ~/.codex/skills/ai-copywriting-audit-en
```

Then invoke it in Codex:

```text
Use $ai-copywriting-audit-en to audit the copy below.
...
For Traditional Chinese commercial copy, use [AI 文案健檢](https://github.com/cityminutes/ai-copywriting-audit-zh).
